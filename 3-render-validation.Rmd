...
tab <- read.table("results/current/validation.summary.txt", header=T, sep="\t")[,1:21]
head(tab)
# create a mediation specific plot
# TODO update those indices
mediation <- tab[,c(1,2,13,14,15)]
...
cohort <- "kora"
load(paste0("results/current/fits/", snp, ".", cohort, ".RData"))
...
med <- mediation(data, snp, "TBC1D10B", cpgs, plot=T)
