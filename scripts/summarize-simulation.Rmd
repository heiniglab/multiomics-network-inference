...
ggplot(tab, aes(y=specificity,x=comparison,fill=comparison)) + gb +  fg + ggtitle("Specificity", subtitle = paste0("(N = ", N, ")"))
ggplot(tab, aes(y=sensitivity,x=comparison,fill=comparison)) + gb +  fg + ggtitle("Sensitivity", subtitle = paste0("(N = ", N, ")"))
ggplot(tab, aes(y=F1.score,x=comparison,fill=comparison)) + gb +  fg + 
  ggtitle("F1.score", subtitle = paste0("(N = ", N, ")"))
ggplot(tab, aes(y=MCC,x=comparison,fill=comparison)) + gb +  fg +
